...
{
    private List<SlackNotificationTemplate> templates;

    @JsonCreator
    public SlackNotificationTemplates(
            @JsonProperty("templates") List<SlackNotificationTemplate> templates)
    {
        this.templates = templates;
    }

    @JsonProperty
    public List<SlackNotificationTemplate> getTemplates()
    {
        return templates;
    }
