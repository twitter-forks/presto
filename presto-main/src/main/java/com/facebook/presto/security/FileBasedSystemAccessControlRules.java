...
public class FileBasedSystemAccessControlRules
{
            ...
            @JsonProperty("principals") Optional<List<PrincipalUserMatchRule>> principalUserMatchRules)
    {
        ...
        this.principalUserMatchRules = principalUserMatchRules.map(ImmutableList::copyOf).orElse(ImmutableList.of());
    }
    ...
    public List<PrincipalUserMatchRule> getPrincipalUserMatchRules()
    {
