...
public class TwitterKerberosAuthenticator
        implements Authenticator
{
    private static final Logger LOG = Logger.get(TwitterKerberosAuthenticator.class);
    ...
    @Inject
    public TwitterKerberosAuthenticator(KerberosConfig config)
    {
