...
@AggregationFunction(value = "learn_olsm_regressor", decomposable = false)
public final class LearnMultiVariateLinearRegressorAggregation
{
    private LearnMultiVariateLinearRegressorAggregation() {}
    ...
    public static void output(@AggregationState LearnState state, BlockBuilder out)
    {
        ...
        Model model = new RegressorFeatureTransformer(new MultipleLinearRegressor(), new FeatureUnitNormalizer());
        model.train(dataset);
