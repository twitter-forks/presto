...
import io.prestosql.plugin.druid.zip.CentralDirectoryFileHeader;
import io.prestosql.plugin.druid.zip.EndOfCentralDirectoryRecord;
import io.prestosql.plugin.druid.zip.LocalFileHeader;
import io.prestosql.plugin.druid.zip.Zip64EndOfCentralDirectory;
import io.prestosql.plugin.druid.zip.Zip64EndOfCentralDirectoryLocator;
import io.prestosql.plugin.druid.zip.ZipFileData;
import io.prestosql.plugin.druid.zip.ZipFileEntry;
import io.prestosql.plugin.druid.zip.ZipUtil;
