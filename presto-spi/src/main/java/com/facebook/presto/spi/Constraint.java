...
public class Constraint<T>
{
    ...
    public Constraint(TupleDomain<T> summary, Predicate<Map<T, NullableValue>> predicate, Optional<List<FieldSet<T>>> fieldSets)
    {
    ...
    public Optional<List<FieldSet<T>>> getFieldSets()
    {
        return fieldSets;
    }
