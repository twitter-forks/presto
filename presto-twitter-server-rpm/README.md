...
The RPM builds by default in Maven, and can be found under the directory `presto-twitter-server-rpm/target/`
...
To install Presto using an RPM, run:
    ...
    rpm -i presto-twitter-server-<version>-1.0.x86_64.rpm
